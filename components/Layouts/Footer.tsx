...
const company = {
  ...
  address:
    "#10/32, 3rd Floor, Balaji Towers, Thiruvika Rd, opp. Sathyam Theatre, Peters Colony, Royapettah, Chennai, Tamil Nadu 600014",
...
/* =========================================================
   GOOGLE MAP
   Exact Tax India Firm embed
========================================================= */

const googleMapEmbed =
  "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3704.506405442789!2d80.25284907803665!3d13.055060254439436!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80f9254126c553d9%3A0x3704d142cc994ec6!2sTax%20India%20Firm!5e1!3m2!1sen!2sin!4v1787757917512!5m2!1sen!2sin";
    ...
    <footer className="relative w-full overflow-hidden bg-[#07111F] !text-white">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8 xl:px-10">
        ...
        <div className="grid grid-cols-1 gap-6 py-10 sm:grid-cols-2 sm:gap-7 sm:py-12 xl:grid-cols-[0.9fr_1fr_1.15fr_1.35fr] xl:gap-8">
          ...
          <InfoPanel className="items-center text-center sm:items-start sm:text-left xl:items-center xl:text-center">
            ...
            <div className="mt-5">
              ...
              <p className="mt-2 max-w-[240px] font-body text-[12px] leading-5 !text-white/70">
                Quality-driven professional services backed by structured
                processes.
              </p>
            </div>
          </InfoPanel>
            ...
            <div className="mt-5 space-y-5">
              <div>
                ...
                <div className="mt-2 space-y-2">
                  <ContactLink href={company.phone1Href}>
                    {company.phone1}
                  </ContactLink>

                  <ContactLink href={company.phone2Href}>
                    {company.phone2}
                  </ContactLink>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-2 space-y-2">
                  <ContactLink href={company.email1Href}>
                    {company.email1}
                  </ContactLink>

                  <ContactLink href={company.email2Href}>
                    {company.email2}
                  </ContactLink>
                </div>
              </div>
          ...
          <InfoPanel>
            <PanelTitle
              icon={<LocationIcon className="h-[18px] w-[18px]" />}
            >
            ...
            <div className="mt-5 overflow-hidden rounded-[18px] border border-white/[0.10] bg-[#0B1826] shadow-[0_18px_45px_rgba(0,0,0,0.20)]">
              <div className="relative h-[220px] w-full sm:h-[230px] xl:h-[220px]">
                <iframe
                  title="Tax India Firm - Royapettah Chennai"
                  src={googleMapEmbed}
                  width="100%"
                  height="100%"
                  loading="lazy"
            ...
            <a
              ...
              className="group mt-4 flex w-full items-center justify-between gap-3 rounded-[14px] border border-[#24B35A]/30 bg-[#24B35A]/[0.08] px-4 py-3 transition-all duration-300 ease-out hover:-translate-y-[1px] hover:border-[#24B35A]/55 hover:bg-[#24B35A]/[0.13]"
            >
        ...
        <div className="flex flex-col gap-5 py-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <p className="max-w-[780px] font-body text-[11px] leading-5 !text-white/55 sm:text-[11.5px] lg:text-right">
